...
sudo pacman --noconfirm -S git tig lsof gnu-netcat openssh sudo curl dmenu cmake xclip unrar slock numlockx wget dnsutils linux-headers squashfs-tools cdrkit
